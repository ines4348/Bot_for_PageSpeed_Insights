<?php
    ...
    const LIST_COMMAND = "/start - начать общение \n/check {указать url} - запуск проверки, можно указать несколько адресов через пробел, каждый адрес начинается с https://. Каждый уникальный адрес из этого запроса добавляется в базу.";
